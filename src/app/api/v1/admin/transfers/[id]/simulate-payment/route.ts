...
//
// NOTE: Stub-mode guard runs AFTER admin auth (via withAdmin) so the
// endpoint doesn't leak its existence to unauthenticated callers.
export const POST = withAdmin(async (request, adminId) => {
