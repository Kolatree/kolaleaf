...
import { POST } from '@/app/api/v1/account/2fa/enable/route'
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/account/2fa/enable', {
    method: 'POST',
...
describe('POST /api/v1/account/2fa/enable', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
