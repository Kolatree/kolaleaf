...
import { GET } from '@/app/api/rates/[corridorId]/route'

describe('GET /api/rates/[corridorId]', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('returns rate data for valid corridor', async () => {
    ...
    const req = new Request('http://localhost/api/rates/aud-ngn')
  ...
  it('returns 404 when no rate exists', async () => {
    ...
    const req = new Request('http://localhost/api/rates/nonexistent')
