...
// Step 2 of the verify-first wizard: enter the 6-digit code emailed by
// step 1, open the 30-minute claim window, and proceed to step 3.
//
// Does NOT issue a session — that only happens once step 3 succeeds.
    ...
    <div className="w-full max-w-sm kola-card-enter">
      ...
      >
        ...
        <p className="text-center mt-2" style={{ fontSize: '12px', color: colors.muted }}>
          <Link href="/register" style={{ color: colors.muted }}>
