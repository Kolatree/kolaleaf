...
import { POST } from '@/app/api/account/2fa/regenerate-backup-codes/route'
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/account/2fa/regenerate-backup-codes', {
    method: 'POST',
...
describe('POST /api/account/2fa/regenerate-backup-codes', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
