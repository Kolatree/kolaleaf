...
import { POST, GET } from '@/app/api/v1/auth/verify-email/route'
...
function postRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/auth/verify-email', {
    method: 'POST',
...
describe('GET /api/v1/auth/verify-email (legacy magic-link redirect)', () => {
