...
import { POST } from '@/app/api/v1/account/change-email/route'
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/account/change-email', {
    method: 'POST',
...
describe('POST /api/v1/account/change-email', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
