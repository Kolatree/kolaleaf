...
import { POST } from '@/app/api/v1/account/phone/verify/route'
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/account/phone/verify', {
    method: 'POST',
...
describe('POST /api/v1/account/phone/verify', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
