...
**Tests:** Latest validation: PII scrubber/logger Vitest 6/6; `npx tsc --noEmit`; targeted iOS `PushPermissionServiceTests` 9/9; `npm run build`; physical iPhone Debug build/install/launch succeeded.
