...
import { POST } from '@/app/api/v1/account/phone/remove/route'
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/account/phone/remove', {
    method: 'POST',
...
describe('POST /api/v1/account/phone/remove', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('returns 422 when phone missing (Zod)', async () => {
